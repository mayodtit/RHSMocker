class TaskTemplate < ActiveRecord::Base
  ...
  def create_deep_copy!(new_service_template)
    transaction do
      new_service_template.task_templates.create!(attributes.slice(*%w(name title description time_estimate priority service_ordinal queue))).tap do |new_task_template|
