class AppointmentTemplateSerializer < ActiveModel::Serializer
  ...
  attributes :id, :title, :description, :version, :unique_id, :state, :state_events, :special_instructions, :reason_for_visit, :scheduled_at_system_event_template_id, :discharged_at_system_event_template_id
