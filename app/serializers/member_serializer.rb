class MemberSerializer < ActiveModel::Serializer
  ...
  def meet_your_pha_text
    "#{object.pha.try(:first_name)} is your Personal Health Assistant. #{object.pha.try(:gender_pronoun).try(:titleize)}’ll start by helping you with #{object.nux_answer.try(:phrase) || 'your health needs'}."
  end
end
