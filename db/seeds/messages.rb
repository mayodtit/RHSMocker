...
MessageWorkflowTemplate.upsert_attributes({message_workflow_id: mw.id, message_template_id: mt.id}, {days_delayed: 1})
...
MessageWorkflowTemplate.upsert_attributes({message_workflow_id: mw.id, message_template_id: mt.id}, {days_delayed: 2})
...
MessageWorkflowTemplate.upsert_attributes({message_workflow_id: mw.id, message_template_id: mt.id}, {days_delayed: 4})
...
MessageWorkflowTemplate.upsert_attributes({message_workflow_id: mw.id, message_template_id: mt.id}, {days_delayed: 6})
...
MessageWorkflowTemplate.upsert_attributes({message_workflow_id: mw.id, message_template_id: mt.id}, {days_delayed: 8})
...
mt = MessageTemplate.upsert_attributes({name: 'Automated Onboarding Message 6'}, {text: "Hi *|member_first_name|*,\n\n" +
                                                                                        ...
                                                                                        "Take care,\n" +
                                                                                        "*|sender_first_name|*"})
MessageWorkflowTemplate.upsert_attributes({message_workflow_id: mw.id, message_template_id: mt.id}, {days_delayed: 10})
