...
ActiveRecord::Schema.define(version: 20131210064535) do
  ...
  add_index "blood_pressures", ["collection_type_id"], name: "index_blood_pressures_on_collection_type_id", using: :btree
  ...
  add_index "contents_symptoms", ["content_id"], name: "index_contents_symptoms_on_content_id", using: :btree
  add_index "contents_symptoms", ["symptom_id"], name: "index_contents_symptoms_on_symptom_id", using: :btree
  ...
  add_index "contents_symptoms_factors", ["content_id"], name: "index_contents_symptom_factors_on_content_id", using: :btree
  add_index "contents_symptoms_factors", ["symptoms_factor_id"], name: "index_contents_symptom_factors_on_symptom_factor_id", using: :btree
  ...
  add_index "phone_calls", ["claimer_id"], name: "index_phone_calls_on_claimer_id", using: :btree
  add_index "phone_calls", ["ender_id"], name: "index_phone_calls_on_ender_id", using: :btree
  add_index "phone_calls", ["identifier_token"], name: "index_phone_calls_on_identifier_token", using: :btree
  ...
  add_index "plan_offerings", ["offering_id"], name: "index_plan_offerings_on_offering_id", using: :btree
  add_index "plan_offerings", ["plan_id"], name: "index_plan_offerings_on_plan_id", using: :btree
  ...
  add_index "symptom_medical_advice_items", ["symptom_medical_advice_id"], name: "index_symptom_medical_advice_items_on_symptom_medical_advice_id", using: :btree
  ...
  add_index "symptom_medical_advices", ["symptom_id"], name: "index_symptom_medical_advices_on_symptom_id", using: :btree
  ...
  add_index "symptom_selfcare_items", ["symptom_selfcare_id"], name: "index_symptom_selfcare_items_on_symptom_selfcare_id", using: :btree
  ...
  add_index "symptoms_factors", ["factor_group_id"], name: "index_symptoms_factors_on_factor_group_id", using: :btree
  add_index "symptoms_factors", ["factor_id"], name: "index_symptoms_factors_on_factor_id", using: :btree
  add_index "symptoms_factors", ["symptom_id"], name: "index_symptoms_factors_on_symptom_id", using: :btree
