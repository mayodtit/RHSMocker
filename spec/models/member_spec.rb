...
describe Member do
  ...
  describe '#specialist_metrics' do
    ...
    it 'should return a hash with todays metrics' do
      specialist.specialist_metrics[:number_of_tasks_completed_today].should eq(0)
      specialist.specialist_metrics[:number_of_tasks_blocked_internally_today].should eq(1)
      specialist.specialist_metrics[:number_of_tasks_blocked_externally_today].should eq(1)
    end
    ...
    context 'if there was a task completed today' do
      ...
      it 'should return the average time of completion for today' do
        specialist.specialist_metrics[:number_of_tasks_completed_today].should eq(1)
        specialist.specialist_metrics[:average_time_of_completion_today].should eq(600)
      end
    end

    it 'should return a hash with this weeks metrics' do
      specialist.specialist_metrics[:number_of_tasks_completed_this_week].should eq(0)
      specialist.specialist_metrics[:number_of_tasks_blocked_internally_this_week].should eq(2)
      specialist.specialist_metrics[:number_of_tasks_blocked_externally_this_week].should eq(2)
    end
    ...
    context 'if there were tasks completed this week' do
      ...
      it 'should return the average time of completion for this week' do
        specialist.specialist_metrics[:number_of_tasks_completed_this_week].should eq(2)
        specialist.specialist_metrics[:average_time_of_completion_this_week].should eq(600)
      end
    end
  end
