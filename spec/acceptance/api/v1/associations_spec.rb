...
resource "Associations" do
  ...
  put '/api/v1/associations' do
    ...
    example_request "[PUT] Update an association b (412)" do
      explanation "Update an association between the user and the specified associate (by ID)"
      status.should == 412
  ...
  put '/api/v1/associations' do
    ...
    example_request "[PUT] Update an association c (404)" do
      explanation "Update an association between the user and the specified associate (by ID)"
      status.should == 404
      JSON.parse(response_body)['reason'].should_not be_empty
    end
  ...
  put '/api/v1/associations' do
    ...
    example_request "[PUT] Update an association d (401)" do
      explanation "Update an association between the user and the specified associate (by ID)"
      status.should == 401
      JSON.parse(response_body)['reason'].should_not be_empty
    end
  ...
  put '/api/v1/associations' do
    ...
    example_request "[PUT] Update an association e (422)" do
      explanation "Update an association between the user and the specified associate (by ID)"
      status.should == 422
      JSON.parse(response_body)['reason'].should_not be_empty
    end
  ...
  delete '/api/v1/associations' do
    ...
    example_request "[DELETE] Delete an association b (412)" do
      explanation "Deletes the specified association"
      status.should == 412
      JSON.parse(response_body)['reason'].should_not be_empty
    end
  ...
  delete '/api/v1/associations' do
    ...
    example_request "[DELETE] Delete an association c (404)" do
      explanation "Deletes the specified association"
      status.should == 404
      JSON.parse(response_body)['reason'].should_not be_empty
    end
  ...
  delete '/api/v1/associations' do
    ...
    example_request "[DELETE] Delete an association d (401)" do
      explanation "Deletes the specified association"
      status.should == 401
      JSON.parse(response_body)['reason'].should_not be_empty
    end
