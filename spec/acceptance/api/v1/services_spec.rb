...
resource "Services" do
  ...
  describe 'activities' do
    ...
    let!(:open_service) { create :service, member: pha, subject: pha, user_facing: true}
    let!(:completed_service) { create :service, :completed, member: pha, subject: pha, user_facing: true}
