RHSMocker::Application.configure do
  ...
  config.action_mailer.smtp_settings = {
    ...
    #:password             => 'Tt8lsCI6JN1Y4Lxdm3Ilrg', # test key - emails will reach Mandrill but not be delivered
    :password             => 'BvpHMAHxVBG5xZ7XtYPstA', # live key - emails will reach recipient
