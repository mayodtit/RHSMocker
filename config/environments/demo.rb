RHSMocker::Application.configure do
  ...
  # Set Mailer Host
  #key = 'fvC1ecAVNBWr9xA-4eVqrA' # test key - emails will reach Mandrill but not be delivered
  key = 'F153KGT2tNOoD40-uSolZg' # live key - emails will reach recipient
  config.action_mailer.perform_deliveries = true
  config.action_mailer.default_url_options = { :host => 'api-demo.getbetter.com' }
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    :address              => 'smtp.mandrillapp.com',
    :port                 => 587,
    :domain               => 'api-demo.getbetter.com',
  ...
  config.after_initialize do
    ...
    Rails.application.routes.default_url_options[:host] = 'api-demo.getbetter.com'
  end
