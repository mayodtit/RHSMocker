...
module RHSMocker
  class Application < Rails::Application
    ...
    config.active_record.observers = :user_action_observer, :scheduled_phone_call_observer
    ...
    # (TS) Mute deprecation warning.  See http://stackoverflow.com/questions/20361428/rails-i18n-validation-deprecation-warning
    ...
    config.action_dispatch.rescue_responses.merge!('CanCan::AccessDenied' => :forbidden,
                                                   ...
                                                   'ActiveRecord::StaleObjectError' => :unprocessable_entity)
