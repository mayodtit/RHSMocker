...
class UserTest < ActiveSupport::TestCase
  ...
  test "should not save without installId" do
  	user = User.new(firstName:'Geoff', lastName:'Clapp')
  ...
  test "should not save with short phone" do
  	user = User.new(firstName:'Geoff', lastName:'Clapp', install_id: '1234', phone:'7054')
  	assert !user.save, "Should not save with short phone number"
  end

  test "should not save with long phone" do
  	user = User.new(firstName:'Geoff', lastName:'Clapp', install_id: '1234', phone:'6507767054-1234')
  	assert !user.save, "Should not save with long phone number"
  end

  test "should save with seven-digit phone" do
  	user = User.new(firstName:'Geoff', lastName:'Clapp', install_id: '1234', phone:'7767054')
  	!user.save
  end


   test "should allow all fields" do
  	user = User.new(firstName:'Geoff', lastName:'Clapp', install_id: '1234', gender: 'M', birthDate:"06/18/1950", imageURL: "shelly.png", 
  						generic_call_time:'Morning', email:"Foo@foo.com", height:'100', phone:'6507767054')
  	!user.save
  end

  test "allowed generic call times" do
  	user = User.new(firstName:'Geoff', lastName:'Clapp', install_id: '1234', generic_call_time:'Morning')
  	!user.save
  ...
  test "should not allow bad generic call times" do
  	user = User.new(firstName:'Geoff', lastName:'Clapp', install_id: '1234', generic_call_time:'foo')
